...
export type SupportedFileType = 'docx' | 'txt' | 'odt' | 'odf' | 'doc';
 ...
 */
export async function extractTextFromFile(fileBuffer: Buffer, fileType: SupportedFileType): Promise<string> {
